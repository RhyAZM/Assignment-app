...
<div class=" navbar-expand-lg navbar-dark bg-white" id="navbar_top" >
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      <a href="userindex.php" class="d-flex align-items-center col-md-1 mb-2 mb-md-0 text-dark text-decoration-none comhead">
        Mega
      </a>

      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        <li><a href="userindex.php" class="nav-link px-2 link-secondary">Home</a></li>
        <li><a href="userSearchByCategory.php" class="nav-link px-2 link-dark">Shopping</a></li>
      </ul>
